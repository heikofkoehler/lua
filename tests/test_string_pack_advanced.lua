...
-- 3. 32-bit integers (l / L / i4 / I4)
local be32 = string.pack(">l", -100000)
assert(#be32 == 4)
assert(string.unpack(">l", be32) == -100000)

local ube32 = string.pack(">L", 3000000000)
assert(#ube32 == 4)
assert(string.unpack(">L", ube32) == 3000000000)
